...
These deployments use the Dioxus `v0.7.0-rc.2` tag. For other releases, check for a branch in this repo with the required Dioxus version.

The deployments assume that you have installed the development build of [Dioxus CLI (`dx`)](`cargo install --git https://github.com/DioxusLabs/dioxus --tag v0.7.0-rc.2 dioxus-cli`)
